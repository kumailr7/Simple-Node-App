...
echo 'Now...'
echo 'Visit http://192.168.58.128:3002 to see your Node.js/React application in action.'
echo '(This is why you specified the "args ''-p 3002:3000''" parameter when you'
